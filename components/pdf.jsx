    ...
    return (
        <div style={{ textAlign: 'center', width: '90%', minWidth: '150px', maxWidth: '250px' }}>
            {isCliente && <PDFDownloadLink document={
                            ...
                            pdfData.incluye && pdfData.incluye.map((i, index) => {
                                return (
                                    ...
                                    <View style={styles.viewKeyValue} key={index}>
                                        <Text style={styles.value}>{pdfData[`CT-INCLUYE${index}`]}</Text>
                                    </View>
                                )
                            })
                        }
                        <Text style={styles.subtitle}>EXCLUYE</Text>
                        {
                            pdfData.excluye && pdfData.excluye.map((i, index) => {
                                return (
                                    ...
                                    <View style={styles.viewKeyValue} key={index}>
                                        <Text style={styles.value}>{pdfData[`CT-EXCLUYE${index}`]}</Text>
                                    </View>
                                )
                            })
                        }
                ...
                fileName={`COTIZACIÓN TERRESTRE ${pdfData && pdfData[`CT-COTIZACION No`] && pdfData[`CT-COTIZACION No`]}`}>
